 ...
 * {
 *     return array('saveRelatedBehavior' => array(
 *         'class' => 'application.components.behaviors.SaveRelatedBehavior')
 *     );
 * }
 *
 * MANY_MANY relations
...
class SaveRelatedBehavior extends CActiveRecordBehavior
{
     ...
     * then existing records will not be deleted before inserting
     *
     * @return bool weather saving was successful
     * @throws CException
     */
