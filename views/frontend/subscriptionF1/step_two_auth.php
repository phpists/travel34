            ...
            <div class="form_wrap form_wrap_no-padding">
                <div class="subscription__sections">
                    <div class="subscription__section subscription__section_left">
                        <form action="<?= $this->createUrl('/subscription/f1/save-step-two-login') ?>" method="POST" id="registration__form" class="form">
                    ...
                    <div class="subscription__section subscription__section_right">
                        <form action="<?= $this->createUrl('/subscription/f1/save-step-two-register') ?>" method="POST" id="registration__form" class="form">
