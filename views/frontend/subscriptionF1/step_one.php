    ...
    <div class="container-wide container-form container-grid">
        <div class="wide-box">
            ...
            <div class="form_wrap form_wrap_no-margin">
                <div class="form_header form_header_margin_medium">Выбор плана</div>
                <div class="container-fluid">

                    <form action="<?= $this->createUrl('/subscription/f1/save-step-one') ?>" method="POST" id="check_subscription">
                        <?= $this->renderPartial('/subscription/subscriptions', [
                            'subscriptions' => $subscriptions
                        ]); ?>
                        <div class="subscriptions__types">
                            <div class="square-radio">
                                <input
                                    type="radio"
                                    id="subscriptionsType1"
                                    name="type"
                                    value="<?= Subscription::MYSELF ?>"
                                    checked
                                >
                                <label for="subscriptionsType1">Подписка для себя</label>
                            </div>
                            <div class="square-radio">
                                <input type="radio" id="subscriptionsType2" name="type" value="<?= Subscription::GIFT ?>">
                                <label for="subscriptionsType2">Подписка в подарок</label>
                            </div>
                        </div>
