<?php
/* @var $this SubscriptionF9Controller */
        ...
        <div class="wide-box">
            ...
            <div class="form_wrap form_wrap_no-margin">
                ...
                <div class="container-fluid">
                    <form action="<?= $this->createUrl('/subscription/f9/save-step-one') ?>" method="POST"
                        ...
                        <div class="form_button_long">
                            <input type="hidden"  name="type" value="<?= Subscription::MYSELF ?>">
