                ...
                <div class="form_wrap">
                    <div class="tab__content">
                        <div class="tab__item"
                            ...
                            <form action="<?= $this->createUrl('/subscription/f1/save-step-two') ?>" method="POST" id="fast-registration__form" class="form mySelfForm">
                        ...
                        <div class="tab__item" style="display: <?= $type == Subscription::GIFT ? '' : 'none' ?>">
                            <form action="<?= $this->createUrl('/subscription/f5/save-step-two-gift') ?>" method="POST" id="fast-registration__form" class="form">
