            ...
            <div class="form_wrap form_wrap_no-padding">
                <div class="subscription__sections">
                    <div class="subscription__section subscription__section_left">
                        <form action="<?= $this->createUrl('/subscription/f5/save-step-two-gift-login') ?>" method="POST" id="registration__form" class="form">
                            <div class="form_header form_header_left">Вход</div>
                            <div class="form_section form_section_margin_little">
                                <div class="form__field">
                                    <input type="email" name="email" placeholder="Email" class="form_long-input" required />
                                ...
                                <div class="form__field">
                                    ...
                                    <?php endif; ?>
                                    <a href="<?= $this->createUrl('/subscription/f1/reset-password') ?>" class="form__link_gray">Я забыл/а пароль</a>
                                </div>
                            </div>
                    ...
                    <div class="subscription__section subscription__section_right">
                        <form action="<?= $this->createUrl('/subscription/f5/save-step-two-gift-register') ?>" method="POST" id="registration__form" class="form">
