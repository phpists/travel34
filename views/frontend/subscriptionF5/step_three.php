<?php
/* @var $this SubscriptionF5Controller */
                    ...
                    <div class="form_section">
                        ...
                        <div class="subscription__hidden">
                            ...
                            <div class="subscriptions__list_hidden">
                                ...
                                <div>Дата начала подписки – с момента активации</div>
                            </div>
                        </div>
                        ...
                        <div class="subscription__payment_block">
                            <div class="form_button_long">
                                <button class="paymentBtn" type="button" data-url="<?= $this->createUrl('/subscription/f5/step-three-payment') ?>">
                                    ОПЛАТИТЬ
                                    <svg
                                            width="14"
                                            height="24"
