...
<div class="post-body subscription__body" style="background-color: #E2E2E2 !important;">
    <div class="container-wide container-form">
        <div class="wide-box">
            ...
            <div class="form_wrap">
                <form action="<?= $this->createUrl('subscription/f11/save-step-two') ?>"
                      method="POST"
                      id="buyGift"
                      class="form">
                    ...
                    <div class="form_section">
                        ...
                        <div class="from-item from-item__mb_80">
                            ...
                            <div class="form__label form__label_description">Письмо придет ровно в выбранные тобой день и час (GMT +2).</div>
                            ...
                            <div class="form__field form__group subscription__select">
                                <select name="time" id="timeSelect" required
                                        class="form-control form_long-input form__select-group">
                                    <?php foreach (Subscription::getTimes() as $time): ?>
                                        <option value="<?= $time ?>" <?php if ($time == Yii::app()->user->hasFlash('old_time')): ?> selected <?php endif; ?>><?= $time ?></option>
                                    <?php endforeach; ?>
                                </select>
