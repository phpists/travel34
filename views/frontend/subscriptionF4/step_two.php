                    ...
                    <div class="form_section">
                        ...
                        <div class="subscription__hidden">
                            ...
                            <div class="subscriptions__list_hidden">
                                ...
                                <div>Дата начала подписки
                                    – <?= Subscription::getSubscriptionStartDate() ?></div>
                            </div>
                        </div>
                        ...
                        <div class="subscription__terms subscription__terms_margin_big subscription__terms_checkbox">
                            <input type="checkbox" class="custom-checkbox" id="terms" name="terms" value="terms"
                                   required/>
                        ...
                        <div class="subscription__payment_block">
                            <div class="form_button_long">
                                <button class="paymentBtn" type="button" data-url="<?= $this->createUrl('/subscription/f4/step-three-payment') ?>">
                                    ОПЛАТИТЬ
                                    <svg
                                            width="14"
                                            height="24"
                        ...
                        <div class="subscription_after_text">Не проходит оплата? Напиши на support@34travel.me, и мы найдем
                            решение!
                        </div>
                    </div>
                </div>
