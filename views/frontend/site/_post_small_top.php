    ...
    <a href="<?= $post->getUrl() ?>">
        <?php if (Yii::app()->userComponent->isAuthenticated()): ?>
            <div class="b-news__short__faves">
                <div data-href="#form_add_post_view" data-post_id="<?= $post->id ?>" data-v="2" class="popup-with-form_faves addPostViewToFaves">
        ...
        <?php endif; ?>
        <img src="<?= $post->getImageUrl('image') ?>" alt="<?= CHtml::encode($post->title) ?>">
