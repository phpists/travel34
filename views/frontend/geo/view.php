...
/* @var $tag string */
/* @var $materials Post[]|object[] */
?>
<div class="b-main">
    <h1 class="b-post__title">#<?= $tag ?></h1>
    <div class="b-news__short__list">
        <?php
        foreach ($materials as $post) {
            if (get_class($post) == 'Post') {
                // render Simple or Small top pos
                ...
                <div class="b-news__short__block b-col__1">
                    <?php if (Yii::app()->userComponent->isAuthenticated()): ?>
                        <div class="b-news__short__faves">
                            <div data-href="#form_add_post_view" class="popup-with-form_faves">
                    ...
                    <div class="b-main__list">
                        <ul>
                            <?php
                            foreach ($post->value as $news) {
                                /** @var $news Post */
                                ?>
                                <li>
                                    <div class="b-main__list__image">
                                        <a href="<?= $news->getUrl() ?>">
                                            <img src="<?= $news->getImageUrl('image_news') ?>" alt="" width="60"
                                                 height="60">
                                        </a>
                                    </div>
