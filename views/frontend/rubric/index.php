    ...
    <div class="b-news__short__list">
        <?php foreach ($rubrics as $rubric): ?>
            <div class="b-news__short__block b-col__1">
                <a href="<?php echo $rubric->getUrl() ?>">
                    <?php if (Yii::app()->userComponent->isAuthenticated()): ?>
                        <div class="b-news__short__faves">
                            <div data-href="#form_add_post_view" data-post_id="<?= $rubric->id ?>" data-id="6" data-v="5" class="popup-with-form_faves addPostViewToFaves">
                                <svg class="svg_<?= $rubric->id ?>" width="16" height="16" viewBox="0 0 16 16" fill="none"
                    ...
                    <div class="b-news__short__image">
                        <img src="<?php echo $rubric->getImageUrl('image') ?>" alt="" width="300" height="200" />
                        <div class="b-news__short__text"><p><?php echo $rubric->description ?></p></div>
                    </div>
                    <h2 class="b-rubrics__short_title">
                        <span><?php echo $rubric->title ?></span>
                    </h2>
                </a>
            </div>
        <?php endforeach; ?>
