...
<div class="form">
    ...
    <?= $form->dropDownListRow($model, 'language', Yii::app()->params['gtuLanguages'], ['prompt' => 'Все языки']) ?>

    <?= $form->dropDownListRow($model, 'banner_place_id', GtuBanner::getBannerPlaceOptions(), ['class' => 'input-xlarge']) ?>
