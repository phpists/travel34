...
$this->widget('bootstrap.widgets.TbExtendedGridView', [
    ...
    'columns' => [
        ...
        //[
        //    'name' => 'type_id',
        //    'filter' => GtbPost::getTypeOptions(),
        //    'value' => function ($data) {
        //        /** @var $data GtbPost */
        //        $options = GtbPost::getTypeOptions();
        ...
        [
            ...
            'value' => function ($data) {
                /** @var $data GtbPost */
                return $data->gtbRubric ? ($data->language == 'en' ? CHtml::encode($data->gtbRubric->title_en) : CHtml::encode($data->gtbRubric->title)) : '';
            },
        ],
        [
            'name' => 'views_count',
        ...
        [
            'name' => 'status_id',
            'class' => 'bootstrap.widgets.TbToggleColumn',
            'filter' => GtbPost::getStatusOptions(),
            'toggleAction' => 'toggle',
