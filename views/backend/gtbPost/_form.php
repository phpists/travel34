...
$cs->registerScriptFile(Common::assetsTime($themeUrl . '/js/gtb_post_edit.js'));
...
<div class="form">
    ...
    <?= CHtml::activeHiddenField($model, 'type_id', ['value' => GtbPost::TYPE_POST]) ?>
    ...
    <?= $form->dropDownListRow($model, 'language', Yii::app()->params['gtbLanguages']) ?>
    ...
    <?= $form->select2Row($model, 'gtb_rubric_id', [
        'data' => CHtml::listData(GtbRubric::model()->findAll(['order' => 'position, title']), 'id', 'title'),
        'options' => [
