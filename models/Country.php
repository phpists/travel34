 ...
 * @property int $world_part_id
 * @property string $url
 *
 * @property Post[] $posts
 *
 * @method Country enabled()
 * @method Country sitemap()
 */
class Country extends TravelActiveRecord
{
    ...
    {
        return [
            'posts' => [self::MANY_MANY, 'Post', 'tr_post_country_assignment(country_id, post_id)'],
        ];
    }
