...
/**
 * This is the model class for table "{{gtb_banner}}".
 *
 * The followings are the available columns in table '{{gtb_banner}}':
 * @property integer $id
 ...
 *
 * @method GtbBanner enabled()
 * @method GtbBanner currentLanguage()
 */
class GtbBanner extends TravelActiveRecord
{
    const PLACE_GTB_HOME_TOP = 1;
    const PLACE_GTB_TOP_ALL = 2;
    const PLACE_GTB_HOME_SMALL_POST = 3;
    const PLACE_GTB_HOME_FULL_WIDTH = 4;
     ...
     * @return GtbBanner the static model class
     */
    ...
    {
        return [
            self::PLACE_GTB_HOME_TOP => 'Вверху главной страницы',
            self::PLACE_GTB_TOP_ALL => 'Сквозной вверху страницы',
            self::PLACE_GTB_HOME_SMALL_POST => 'Вместо поста на главной',
            self::PLACE_GTB_HOME_FULL_WIDTH => 'Имиджевый на главной',
        ];
    }
