...
class GtuPostController extends BackEndController
{
    /**
    ...
    public function actionCreate()
    {
        ...
        if (isset($_POST['GtuPost'])) {
            $model->attributes = $_POST['GtuPost'];
            $rewriteUrl = false;
            $url = Transliteration::slug($model->title);
            $postWithSameUrl = GtuPost::model()->findByAttributes(['url' => $url]);
    ...
    public function actionUpdate($id)
    {
        ...
        if (isset($_POST['GtuPost'])) {
            ...
            $postWithSameUrl = GtuPost::model()->find('url = :post_url AND id != :post_id', [':post_url' => $model->url, ':post_id' => $model->id]);
            if (!empty($postWithSameUrl)) {
    ...
    {
        $model = new GtuPost('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['GtuPost'])) {
            $model->attributes = $_GET['GtuPost'];
        }
    ...
    {
        $model = GtuPost::model()->findByPk($id);
        if ($model === null) {
     ...
     * @param GtuPost $model the model to be validated
     */
    ...
    public function actionEditableSaver()
    {
        ...
        $es = new TbEditableSaver('GtuPost');
    ...
    public function actionCreateStyle($id)
    {
        ...
        $model->page_keys = [Style::PAGE_KEY_GTU_POST];
