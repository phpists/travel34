...
class PostController extends BackEndController
{
    ...
    public function actionCreate()
    {
        ...
        if (isset($_POST['Post'])) {
            ...
            $postWithSameUrl = Post::model()->findByAttributes(['url' => $url]);
            ...
            $model->cities = $model->citiesIds;
            $model->countries = $model->countriesIds;
    ...
    public function actionUpdate($id)
    {
        ...
        if (isset($_POST['Post'])) {
            ...
            $postWithSameUrl = Post::model()->find('url = :post_url AND id != :post_id', [':post_url' => $model->url, ':post_id' => $model->id]);
            if (!empty($postWithSameUrl)) {
    ...
    public function actionCreateStyle($id)
    {
        ...
        $model->page_keys = [Style::PAGE_KEY_POST];
