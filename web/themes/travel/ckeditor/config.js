...
CKEDITOR.editorConfig = function (config) {
    config.font_names = 'league_gothicregular/league_gothicregular, league_gothicregular-ext,sans-serif;'
        + 'helioscondcregular/helioscondcregular,sans-serif;'
        + 'helioscondcbold/helioscondcbold,sans-serif;'
        + 'helioscondcbold_italic/helioscondcbold_italic,sans-serif;'
        + 'helioscondcitalic/helioscondcitalic,sans-serif;'
        + 'aa_bebas_neueregular/aa_bebas_neueregular,sans-serif;'
        + 'bebas_neue_regularregular/bebas_neue_regularregular,sans-serif;'
        + 'bebas_neuebold/bebas_neuebold,sans-serif;'
        + 'PT Serif/PT Serif,serif;'
        + 'Roboto Condensed/Roboto Condensed,sans-serif;'
        + 'DrukCyr/DrukCyr,sans-serif;'
        + 'Druk-Text-Cyr/Druk-Text-Cyr,sans-serif;'
        + 'Druk-Cyr-Wide/Druk-Cyr-Wide,sans-serif;'
