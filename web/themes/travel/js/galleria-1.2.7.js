...
Galleria = function() {
    ...
    // add some elements
    var divs =  'image-nav image-nav-left image-nav-right container stage images  ' +
                'info info-text info-title info-description ' +
                'thumbnails thumbnails-list thumbnails-container thumb-nav-left thumb-nav-right ' +
                'loader counter tooltip play',
        spans = 'current total';
    ...
    _init: function() {
        ...
        this.append({
            ...
            'info' :
                ['info-text'],            
            'stage' :
                ['images', 'loader', 'counter', 'play'],
            'thumbnails-list' :
                ['thumbnails'],
            'thumbnails-container' :
                ['thumb-nav-left', 'thumbnails-list', 'thumb-nav-right'],
            'container' :
                ['stage', 'thumbnails-container', 'info', 'tooltip', 'image-nav'],
             'image-nav' :
