<div class="form_wrap form__edit_wrap form__popup mfp-hide" id="form_create_collection">
    <form action="<?= $this->createUrl('/profile/add-collection') ?>" method="POST" id="form__create" class="form">
